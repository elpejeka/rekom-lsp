	...
	<div class="page-header page-header-inverse">
		...
		<div class="navbar navbar-inverse navbar-transparent">
			<div class="navbar-header">
				<a class="navbar-brand" href="{{route('list.lsp')}}"><img src="{{url('aset/images/logo.png')}}" alt=""></a>
										...
										<ul class="menu-list">
											...
											<li>
												...
												<ul>
													...
													<li><a href="../../../layout_4/LTR/default/index.html" id="layout4">Layout 3</a></li>
					...
					<table class="table datatable-basic">
                      ...
                      @foreach ($permohonan as $item)
						...
						<tr>
							...
							<td>{{$item->administrations->jumlah_skema}}</td>
							<td>{{$item->administrations->kategori_lsp}}</td>
							<td>
