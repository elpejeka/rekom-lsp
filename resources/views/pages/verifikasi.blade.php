    ...
    <div class="content-detached">
        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                <h6 class="panel-title">Tim Sekretariat LSP</h6>
            ...
            <div class="panel-body">
                <div class="tabbable">
                    <ul class="nav nav-tabs nav-tabs-solid nav-justified">
                        ...
                        <li><a href="#akta-pendirian" data-toggle="tab">Akta Pendirian</a></li>
                        <li><a href="#akta-perubahan" data-toggle="tab">Akta Perubahan</a></li>
                        <li><a href="#lisensi-lsp" data-toggle="tab">Lisensi LSP</a></li>   
                        <li><a href="#sk-bnsp" data-toggle="tab">SK BNSP</a></li>   
                        <li><a href="#sertifikasi-lpjk" data-toggle="tab">Skema LPJK</a></li>   
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="akta-pendirian">
                            <div class="col-md-12">
                                <div class="panel panel-flat panel-collapsed">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="content-group-lg">
                                                    ...
                                                    <p class="content-group">Akta Pendirian</p>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <a href="" target="_blank" type="button" name="btn_cek_13" style="float: right" 
                                ...
                                <div class="table-responsive">
                                    <table class="table table-lg">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>No Akta</td>
                                                <td>{{$data->akta_pendirian_table}}</td>
                                            </tr>
                                            <tr>
                                                <td>Nama Notaris</td>
                                                <td></td>
                        ...
                        <div class="tab-pane" id="akta-perubahan">
                            <div class="col-md-12">
                                <div class="panel panel-flat panel-collapsed">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="content-group-lg">
                                                    <h6 class="text-semibold">#</h6>
                                                    <p class="content-group">Akta Perubahan</p>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <a href="" target="_blank" type="button" name="btn_cek_13" style="float: right" 
                        ...
                        <div class="tab-pane" id="lisensi-lsp">
                            <div class="col-md-12">
                                <div class="panel panel-flat panel-collapsed">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="content-group-lg">
                                                    <h6 class="text-semibold">#</h6>
                                                    <p class="content-group">Lisensi LSP</p>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <a href="" target="_blank" type="button" name="btn_cek_13" style="float: right" 
                        ...
                        <div class="tab-pane" id="sk-bnsp">
                            <div class="col-md-12">
                                <div class="panel panel-flat panel-collapsed">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                            Surat Keputusan BNSP
                                        </h5>
                                        <div class="heading-elements">
                                            <ul class="icons-list">
                                                <li><a data-action="collapse"></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="content-group-lg">
                                                    <h6 class="text-semibold">#</h6>
                                                    <p class="content-group">SK BNSP</p>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <a href="" target="_blank" type="button" name="btn_cek_13" style="float: right" 
                        ...
                        <div class="tab-pane" id="sertifikasi-lpjk">
                            <div class="col-md-12">
                                <div class="panel panel-flat panel-collapsed">
                                    <div class="panel-heading">
                                        <h5 class="panel-title">
                                            Skema Sertifikasi LPJK
                                        </h5>
                                        <div class="heading-elements">
                                            <ul class="icons-list">
                                                <li><a data-action="collapse"></a></li>
                    ...
                    <div class="col-md-6 mt-5">
                        <div class="col-lg-10">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Alasan Tolak Permohonan">
                                <span class="input-group-btn">
                                    <button class="btn bg-danger" type="button">Tolak</button>
                                </span>
                            </div>
                        </div>
                    </div>
