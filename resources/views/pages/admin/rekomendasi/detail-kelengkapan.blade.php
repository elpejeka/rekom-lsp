                            ...
                            <table class="table">
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <div class="input-group">
                                      <input class="form-control" type="text" placeholder="comment...." name="keterangan_surat">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="input-group">
                                      <input class="form-control" type="text" placeholder="comment...." name="keterangan_asosiasi">
                                      <button class="btn btn-secondary" type="button"> <span></span></button>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>
                                    <div class="input-group">
                                      <input class="form-control" type="text" placeholder="comment...." name="keterangan_akta">
                                      <button class="btn btn-secondary" type="button"> <span></span></button>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>
                                    <div class="input-group">
                                      <input class="form-control" type="text" placeholder="comment...." name="keterangan_komitmen">
                                      <button class="btn btn-secondary" type="button"> <span></span></button>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>
                                    <div class="input-group">
                                      <input class="form-control" type="text" placeholder="comment...." name="keterangan_akreditasi">
                                      <button class="btn btn-secondary" type="button"> <span></span></button>
                                    </div>
                                  </td>
                                </tr>
                          ...
                          <table class="table">
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <div class="input-group">
                                    <input class="form-control" type="text" placeholder="comment...." name="keterangan_organisasi">
                                    <button class="btn btn-secondary" type="button"> <span></span></button>
                                  </div>
                                </td>
                              </tr>
                        ...
                        <table class="table">
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div class="input-group">
                                  <input class="form-control" type="text" placeholder="comment...." name="keterangan_klasifikasi">
                                  <button class="btn btn-secondary" type="button"> <span></span></button>
                                </div>
                              </td>
                            </tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td> <a href="{{asset('storage/'.$item->upload_persyaratan)}}" target="_blank" type="button" name="btn_cek_13" style="float: right" 
                                  ...
                                  <b><i class="icofont icofont-file-document"></i></b> Softcopy</a></td>
                                <td>
                                  <select class="select-search" name="status_acuan">
                                    <option value="1">Ada</option>
                                    <option value="0">Tidak ada</option>    
                                  </select>
                                </td>
                                <td>
                                  <input type="text" placeholder="comment skema " name="keterangan_skema">
                                  <br>
                                  <br>
                                  <input type="text" placeholder="comment acuan skema" name="keterangan_acuan">
                                </td>
                              </tr>
                              @endforeach
                            </tbody>
