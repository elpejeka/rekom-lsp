...
>
  <div class="px-40 py-20 bg-white rounded-md shadow-xl">
    <div class="flex flex-col items-center">
      <h1 class="font-bold text-blue-600 text-6xl">Status 11</h1>

      <h6 class="mb-2 text-xl font-bold text-center text-gray-800 md:text-2xl">
        <span class="text-red-500">Oops!</span> Permohonan Proses Perbaikan dalam Portal Perizin PUPR
      </h6>
    ...
    <div class="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
        <div class="w-full md:w-1/2">
            ...
            <div class="mb-10 md:mb-20 text-gray-600 font-light">
                <h1 class="font-black uppercase text-3xl lg:text-5xl text-yellow-500 mb-10">Status 11</h1>
                <p>Permohonan Rekomendasi Dalam Perbaikan Pada Portal Perizinan PUPR</p>
                <p>Cek Menu Permohonan Portal untuk Update Data Perbaikan Permohonan Rekomendasi</p>
            </div>
            <div class="mb-20 md:mb-0">
                <a href="{{route('home')}}" class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-yellow-500 hover:text-yellow-600"><i class="mdi mdi-arrow-left mr-2"></i>Go Back</a>
            </div>
        </div>
        <div class="w-full md:w-1/2 text-center">
            ...
            <a href="https://www.freepik.com/vectors/business" target="_blank" class="text-xs text-gray-300"></a>
        </div>
    </div>
