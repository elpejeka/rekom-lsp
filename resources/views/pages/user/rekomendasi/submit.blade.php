                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-right">
                                <a href="{{ route('submitted', $data->id) }}?status_submit=submit"
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs" id="icon-tab" role="tablist">
                                ...
                                <li class="nav-item"><a class="nav-link txt-secondary" id="perpanjangan-icon-tab"
                                    data-bs-toggle="tab" href="#perpanjangan" role="tab" aria-controls="contact-icon"
                                    aria-selected="false"><i class="icofont icofont-building"></i>Persyaratan Perpanjangan</a></li>
                                @endif
                                                            ...
                                                            <table class="table">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ asset('storage/' . $permohonan->administrasi->upload_persyaratan) }}"
                                                                                target="_blank" type="button"
                                                                                name="btn_cek_13" style="float: right"
                                                                                class="open-delete btn btn-primary btn-labeled btn-rounded">
                                                                                <b><i
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ asset('storage/' . $permohonan->administrasi->akta_pendirian) }}"
                                                                                target="_blank" type="button"
                                                                                name="btn_cek_13" style="float: right"
                                                                                class="open-delete btn btn-primary btn-labeled btn-rounded">
                                                                                <b><i
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ asset('storage/' . $permohonan->administrasi->komitmen_asesor) }}"
                                                                                target="_blank" type="button"
                                                                                name="btn_cek_13" style="float: right"
                                                                                class="open-delete btn btn-primary btn-labeled btn-rounded">
                                                                                <b><i
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ asset('storage/' . $permohonan->administrasi->surat_akreditasi) }}"
                                                                                target="_blank" type="button"
                                                                                name="btn_cek_13" style="float: right"
                                                                                class="open-delete btn btn-primary btn-labeled btn-rounded">
                                                                                <b><i
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ ucfirst($data->jenis_permohonan) }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Nama LSP</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span
                                                                        class="badge badge-info">{{ $permohonan->administrasi->unsur->asosiasi }}</span>
                                                                    <span
                                                                        class="badge badge-info">{{ $permohonan->administrasi->unsur1->asosiasi }}</span>
                                                                    <span
                                                                        class="badge badge-info">{{ $permohonan->administrasi->unsur2->asosiasi }}</span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $permohonan->administrasi->status_kepemilikan }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>No Telpon</td>
                                                        ...
                                                        <table class="table">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{ asset('storage/' . $permohonan->organization) }}"
                                                                            target="_blank" type="button"
                                                                            name="btn_cek_13" style="float: right"
                                                                            class="open-delete btn btn-primary btn-labeled btn-rounded">
                                                                            <b><i
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>Nama Pengarah</td>
                                                                    <td>{{ $permohonan->organization->pengarah ?? '-' }}
                                                                    </td>
                                                                    <td>{{ $permohonan->organization->no_telp_pengarah ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Nama Pengarah</td>
                                                                    <td>{{ $permohonan->organization->pengarah_1 ?? '-' }}
                                                                    </td>
                                                                    <td>{{ $permohonan->organization->no_telp_pengarah_1 ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Nama Pengarah</td>
                                                                    <td>{{ $permohonan->organization->pengarah_2 ?? '-' }}
                                                                    </td>
                                                                    <td>{{ $permohonan->organization->no_telp_pengarah_2 ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Nama Pengarah</td>
                                                                    <td>{{ $permohonan->organization->pengarah_3 ?? '-' }}
                                                                    </td>
                                                                    <td>{{ $permohonan->organization->no_telp_pengarah_3 ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Nama Pengarah</td>
                                                                    <td>{{ $permohonan->organization->pengarah_4 ?? '-' }}
                                                                    </td>
                                                                    <td>{{ $permohonan->organization->no_telp_pengarah_4 ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Ketua Pelaksana</td>
                                                                    <td>{{ $permohonan->organization->ketua ?? '-' }}</td>
                                                                    <td>{{ $permohonan->organization->no_ketua ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Penanggungjawab Bagian Umum</td>
                                                                    <td>{{ $permohonan->organization->umum ?? '-' }}</td>
                                                                    <td>{{ $permohonan->organization->no_umum ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Penanggungjawab Bagian Sertifikasi</td>
                                                                    <td>{{ $permohonan->organization->sertifikasi ?? '-' }}
                                                                    </td>
                                                                    <td>{{ $permohonan->organization->no_sertifikasi ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Penanggungjawab Bagian Manajemen Mutu</td>
                                                                    <td>{{ $permohonan->organization->manajemen_mutu ?? '-' }}
                                                                    </td>
                                                                    <td>{{ $permohonan->organization->no_manajemen ?? '-' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Jumlah Karyawan</td>
                                                                    <td colspan="2">
                                                                        {{ $permohonan->administrasi->jenis_lsp }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                        ...
                                                        <table class="table" id="list_skema">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Laporan tindak lanjut hasil pemantauan dan evaluasi kinerja LSP dengan kondisi atau perbaikan yang dilakukan LSP</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                               <tr>
                                                                <td>#</td>
                                                                <td>
                                                                    <a href="{{ asset('storage/' . $data->perpanjangan->sk_lisensi) }}"
                                                                        target="_blank" type="button"
                                                                        name="btn_cek_13"
                                                                        class="open-delete btn btn-primary btn-labeled btn-rounded">
                                                                        <b><i class="icon-file-check"></i></b>
                                                                ...
                                                                <td>
                                                                    <a href="{{ asset('storage/' . $data->perpanjangan->rekapitulasi_laporan) }}"
                                                                        target="_blank" type="button"
                                                                        name="btn_cek_13"
                                                                        class="open-delete btn btn-primary btn-labeled btn-rounded">
                                                                        <b><i class="icon-file-check"></i></b>
                                                                ...
                                                                <td>
                                                                    <a href="{{ asset('storage/' . $data->perpanjangan->laporan_tindak_lanjut) }}"
                                                                        target="_blank" type="button"
                                                                        name="btn_cek_13"
                                                                        class="open-delete btn btn-primary btn-labeled btn-rounded">
                                                                        <b><i class="icon-file-check"></i></b>
