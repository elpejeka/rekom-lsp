  ...
  <div class="row">
      <div class="col-sm-12 col-xl-12">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal" action="{{route('integrasi.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-md-6">
                  <div class="form-group">
                      <label class="control-label">Username SISFO BNSP</label>
                      <input type="text" class="form-control @error('username_bnsp') is-invalid @enderror" name="username_bnsp" required>
                      @error('username_bnsp')
              ...
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('password_bnsp') is-invalid @enderror" name="password_bnsp" required>
                    @error('password_bnsp')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
            ...
            <div class="row mt-3">
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_ketua') is-invalid @enderror" name="nama_ketua" required>
                    @error('nama_ketua')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
              ...
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nik_ketua') is-invalid @enderror" name="nik_ketua" required>
                    @error('nik_ketua')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
              ...
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control @error('email_ketua') is-invalid @enderror" name="email_ketua" required>
                    @error('email_ketua')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
            ...
            <div class="row mt-3">
              <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <input type="file" class="form-control @error('surat_permohonan') is-invalid @enderror" name="surat_permohonan" required>
            ...
            <div class="row mt-3">
              <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <input type="file" class="form-control @error('list_akun') is-invalid @enderror" name="list_akun" required>
                      @error('list_akun')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row mt-3">
              <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <input type="file" class="form-control @error('format_skema') is-invalid @enderror" name="format_skema" required>
                      @error('format_skema')
                        <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                        </span>
