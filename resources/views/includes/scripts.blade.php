...
<script type="text/javascript" src="{{url('assets/js/pages/navbar_multiple.js')}}"></script>
...
<script src="{{url('assets/js/plugins/uploaders/fileinput/fileinput.min.js')}}"></script>
