                  ...
                  <table class="table table-bordered" id="list" width="100%" cellspacing="0">
                      <thead>
                        ...
                        <tr>
                          ...
                          <td>{{date('d-m-Y', strtotime($item->status_kelengkapan)) }}</td>
                          <td>{{date('d-m-Y', strtotime($item->status_verifikasi)) }}</td>
                          <td>{{date('d-m-Y', strtotime($item->status_permohonan)) }}</td>
                          <td><a href="{{route('verifikasi', $item->id)}}?cek-kelengkapan" class="btn btn-success">Detail</a></td>
                        </tr>
                        @endforeach
                        </tbody>
                  </table>
