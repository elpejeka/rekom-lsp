                ...
                <div class="row mt-4">
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="nama_skema" id="nama_skema">
                ...
                <div class="row mt-4">
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input class="form-control @error('acuan_skema') is-invalid @enderror" name="acuan_skema" type="text" id="acuan" readonly>
                      </div>
                      @error('acuan_skema')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
