            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-bubbles4"></i>
                        <span class="visible-xs-inline-block position-right">Messages</span>
                        <span class="badge bg-warning-400">{{count(App\LogPencatatan::whereNull('deleted_at')->orderBy('id', 'DESC')->get())}}</span>
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-content width-350">
                        ...
                        <ul class="media-list dropdown-content-body">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <a href="#" class="media-heading">
                                        <span class="text-semibold">{{$item->nama_lsp}}</span>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="icon-bubbles4"></i>
                        <span class="visible-xs-inline-block position-right">Messages</span>
                        <span class="badge bg-warning-400">{{count(App\Perbaikan::where('users_id', Auth::user()->id)->get())}}</span>
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-content width-350">
                        ...
                        <ul class="media-list dropdown-content-body">
                            @foreach (App\Perbaikan::where('users_id', Auth::user()->id)->get() as $notification)
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <span class="text-muted">{{$notification->komen}}</span>
                                </div>
                            </li>    
                            @endforeach
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li><a href="{{route('penambahan')}}"><i class="icon-file-pdf"></i>Penambahan Ruang Lingkup</a></li>
                    @elseif(Auth::user()->roles == 'admin')
                    <li><a href="{{route('portal.index')}}"><i class="icon-pen-plus position-left"></i> Permohonan Portal</a></li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <li><a href="{{route('sk.lisensi')}}"><i class="icon-bookmarks"></i> Legalitas LSP</a></li>
